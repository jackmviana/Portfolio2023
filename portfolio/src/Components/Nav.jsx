...
export default function Nav() {
    ...
    return (
        <div className=" bg-transparent z-20 relative">
            <button data-collapse-toggle="collapse" type="button" class="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="collapse" aria-expanded="false">
